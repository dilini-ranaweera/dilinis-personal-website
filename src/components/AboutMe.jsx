  ...
  return (
    <div className="about-me-wrapper">
      <Grid container spacing={2}>
        ...
        <Grid item xs={6}>
          <Fade righ duration={1200} delay={600}>
            <p className="about-me-text">
              I am a rising third-year student at the University of
              Pennsylvania, and I am an alumni of Seneca Valley Senior High
              School. I am studying Computer Science <span>{"\u{1F4BB}"}</span>,
              with minors in Mathematics and Statistics. I love learning about
              anything Computer Science - from Front-end Web Development to
              Machine Learning to Web3, I aspire to learn it all. <br /> <br />
              ...
              Science Teaching Assistant <CalculateIcon /> (CIS 1600 TA), and
              join the Executive Board for the Bridge to Mathematics club.{" "}
              <br /> <br />
